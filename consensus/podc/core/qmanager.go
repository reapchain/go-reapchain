...
//	for index, validator := range qmanager.DBDataList {
//
//		var num uint64
//
//		if qmanager.QRNGDeviceStat == true{
//			log.Info("QRNG " + string(index), " Random Nums" , qmanager.QRNGDeviceStat)
...
//
//		} else {
//			log.Info("Suedo Random "  + string(index) , " Random Nums", qmanager.QRNGDeviceStat)
//			num = rand.Uint64()
//		}
