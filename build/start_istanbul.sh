...
cp passwd.txt node1/data/
cp passwd.txt node2/data/
cp passwd.txt node3/data/
cp passwd.txt node4/data/
cp passwd.txt node5/data/
...
#./bin/geth --networkid 2017 --port 30301 --nodiscover --datadir ./node1/data --mine --minerthreads 1 --syncmode "full" \
...
open -na Terminal /Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build -e "`/Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build/bin/geth --networkid 2017 --port 30401  --datadir ./node1/data --mine --minerthreads 1 \
...
open -na Terminal /Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build -e "`/Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build/bin/geth --networkid 2017 --port 30402  --datadir ./node2/data --mine --minerthreads 1 \
--syncmode "full"  --rpc --rpcport 8542 --rpccorsdomain "*" --rpcapi="db,eth,net,web3,personal,web3,miner,admin,debug" \
--unlock 0 --password /Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build/passwd.txt --verbosity 6 --nat extip:192.168.0.2 --ipcdisable --debug`" &

open -na Terminal /Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build -e "`/Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build/bin/geth --networkid 2017 --port 30403  --datadir ./node3/data --mine --minerthreads 1 \
--syncmode "full"  --rpc --rpcport 8543 --rpccorsdomain "*" --rpcapi="db,eth,net,web3,personal,web3,miner,admin,debug" \
--unlock 0 --password /Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build/passwd.txt --verbosity 6 --nat extip:192.168.0.2 --ipcdisable --debug`" &

open -na Terminal /Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build  "`/Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build/bin/geth --networkid 2017 --port 30404  --datadir ./node4/data --mine --minerthreads 1 \
--syncmode "full"  --rpc --rpcport 8544 --rpccorsdomain "*" --rpcapi="db,eth,net,web3,personal,web3,miner,admin,debug" \
--unlock 0 --password /Users/yongilchoi/go/src/github.com/ethereum/go-ethereum/build/passwd.txt --verbosity 6 --nat extip:192.168.0.2 --ipcdisable --debug`"



./bin/geth  --networkid 2017 --port 30310  --datadir ./node3/data --mine --minerthreads 1 --syncmode "full" \
 --rpc --rpcport 8547 --rpccorsdomain "*" --rpcapi="db,eth,net,web3,personal,web3,miner,admin,debug"  --ipcdisable \
 --unlock 0 --password passwd.txt --verbosity 6 --nat extip:192.168.0.2
